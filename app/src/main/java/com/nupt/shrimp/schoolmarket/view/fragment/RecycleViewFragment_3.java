...
public class RecycleViewFragment_3 extends Fragment implements OnRefreshListener{
    ...
    private final static String CATEGORY = "3";
    private final static String FIND_ALL_DATA = "http://115.159.98.48:8080/Shrimp/service/query?param=query&category="+CATEGORY;

    private RecycleViewFragment_3() {}
    private static RecycleViewFragment_3 singleton = null;
    public static RecycleViewFragment_3 getInstance() {
        if (mRecyclerView == null) {
            singleton = new RecycleViewFragment_3();
        }
        return singleton;
    }
    ...
    private void init() {
        ...
        mHandler= new PreviewHandler(RecycleViewFragment_3.this);
    }
    ...
    private static class PreviewHandler extends Handler {
        ...
        private WeakReference<RecycleViewFragment_3> ref;

        PreviewHandler(RecycleViewFragment_3 context) {
            ref = new WeakReference<>(context);
        }

        @Override
        public void handleMessage(Message msg) {
            final RecycleViewFragment_3 fragmentContext = ref.get();
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(url,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        mSwipeRefreshWidget.setOnRefreshListener(RecycleViewFragment_3.this);
                    }
