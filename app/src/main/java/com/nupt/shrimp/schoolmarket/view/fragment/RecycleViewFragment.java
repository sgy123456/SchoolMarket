...
public class RecycleViewFragment extends Fragment implements OnRefreshListener{
    ...
    private final static String FIND_ALL_DATA = "http://115.159.98.48:8080/Shrimp/service/query?param=query&category=1";
    private RecycleViewFragment() {}
    private static RecycleViewFragment singleton = null;
    public static RecycleViewFragment getInstance() {
        if (mRecyclerView == null) {
            singleton = new RecycleViewFragment();
        }
        return singleton;
    }
    ...
    private void init() {
        ...
        mHandler= new PreviewHandler(RecycleViewFragment.this);
    }
    ...
    private static class PreviewHandler extends Handler {
        ...
        private WeakReference<RecycleViewFragment> ref;

        PreviewHandler(RecycleViewFragment context) {
            ref = new WeakReference<>(context);
        }

        @Override
        public void handleMessage(Message msg) {
            final RecycleViewFragment fragmentContext = ref.get();
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for(int i = 0; i< response.length();i++) {
                                ...
                                if(itemModel.getCatrgory().equals("1")) {
                        ...
                        mSwipeRefreshWidget.setOnRefreshListener(RecycleViewFragment.this);
                    }
